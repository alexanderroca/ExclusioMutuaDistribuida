...
public class RicartAgrawalaHeavyweight extends Thread{
    ...
    public RicartAgrawalaHeavyweight(int numLightweights, boolean debug, int port, int[] lightPorts, InetAddress heavyAddress, InetAddress lightAddress){
        ...
        public void run(){
            ...
            try {
                ...
                while(true){
                    ...
                    try {
                        RicartAgrawalaLightHeavyMessage auxLM = (RicartAgrawalaLightHeavyMessage) ois.readObject();
    ...
    private void sendActionToLightweight(Socket lightConnSocket, int id){
        ...
        while(!send){
            ...
            try {
                ...
                RicartAgrawalaLightHeavyMessage auxLHM = new RicartAgrawalaLightHeavyMessage(true);
