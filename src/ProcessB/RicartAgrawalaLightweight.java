...
public class RicartAgrawalaLightweight extends Thread{
    ...
    public RicartAgrawalaLightweight(int[] lightPorts, int lightQuantity, int myPort, InetAddress heavyAddress,
    ...
    private synchronized void notifyHeavyWeight(){
        ...
        RicartAgrawalaLightHeavyMessage auxLLHM = new RicartAgrawalaLightHeavyMessage(true);
        try {
    ...
    private synchronized void sendBroadCastRelease(){
        ...
        for (int i = 0; i < lightQuantity; i++){
            ...
            if(i != id) {
                ...
                try {
                    RicartAgrawalaMessage releaseCsMessage = new RicartAgrawalaMessage(clock.getClock(id), id, "release");
        ...
        for (int i = 0; i < lightQuantity;  i++){
            ...
            if(i != id) {
                ...
                try {
                    ...
                    RicartAgrawalaMessage requestCsMessage = new RicartAgrawalaMessage(clock.getClock(id), id, "request");
    ...
    private synchronized void sendAcknowledge(int foreignId) throws IOException {
        clock.tick();
        RicartAgrawalaMessage aLM = new RicartAgrawalaMessage(clock.getClock(id), id, "acknowledge");
    ...
    private class LightSocketListener extends Thread{
        ...
        public synchronized void run(){
            ...
            while(true){
                ...
                try {
                    RicartAgrawalaMessage auxLM = (RicartAgrawalaMessage) ois.readObject();
        ...
        public synchronized void run(){
            ...
            while(serverStatus){
                ...
                try {
                    ...
                    RicartAgrawalaMessage auxLM = new RicartAgrawalaMessage(0, id, "handshake");
            ...
            if(i != id){
                ...
                while(!connected){
                    try {
                        ...
                        ObjectOutputStream auxOos = new ObjectOutputStream(auxSocket.getOutputStream());
                        auxOos.writeObject(new RicartAgrawalaMessage(clock.getClock(id), id, "handshake"));
                        ...
                        RicartAgrawalaMessage auxLM = (RicartAgrawalaMessage) auxOis.readObject();
        ...
        public synchronized void run(){
            ...
            while (true){
                ...
                try {
                    ...
                    RicartAgrawalaLightHeavyMessage auxLLHM = (RicartAgrawalaLightHeavyMessage) ois.readObject();
